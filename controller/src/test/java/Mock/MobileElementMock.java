...
public class MobileElementMock extends ElementMock implements IMobileElement {
     ...
     */
    public MobileElementMock(SpriteMock sprite, Permeability permeability, StateElement stateElement) {
     ...
     * @return void
     */
    public synchronized void setSprite(SpriteMock sprite) {
        this.sprite = sprite;
    }
