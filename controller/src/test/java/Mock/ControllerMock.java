...
public class ControllerMock implements IController {
	 ...
	 * The move
	 */
	private ClockLorannMock move;

	/**
	 * The list of monsters to be killed
	 */
	public ArrayList<IMobileElement> DeadMonsters;

	/**
	 * Lorann
	 */
	public IMobileElement lorann;
	/**
	 * The spell
	 */
	...
	public void init() {
		...
		this.lorann = this.model.getMap().getHero();
